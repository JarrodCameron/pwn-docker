...
RUN apk add aws-cli bash bat curl entr fzf git htop iproute2 jq man-db \
	man-pages net-tools netcat-openbsd nginx nmap npm openssh-server openssl \
	plocate py3-impacket python3 ripgrep rlwrap samba strace supervisor tmux \
	vim wget
