...
RUN apt-get install -y apt-utils ascii awscli bat build-essential cargo cmake \
	...
	openssh-server pahole patchelf php procps proxychains psmisc python2 \
	python3 python3-dev python3-pip qemu-system ripgrep rubygems strace tmux \
	valgrind vim virtualenvwrapper wget
